...
export const studentSelectQuerySlice = createSlice({
...
export const {changeProjectYear, changeDiv,changeSem,changeStudentBranch,changeStudentYear,changeSubject, changeIsApproved,changeIsApprovedByAdmin} = studentSelectQuerySlice.actions
export default studentSelectQuerySlice.reducer